// ==UserScript==
// @name        🏆 [#1 Chess Cheat] NOCOOB (Advanced Chess Assistance System)
// @name:en     🏆 [#1 Chess Cheat] NOCOOB (Advanced Chess Assistance System)
// @name:fi     🏆 [#1 Chess Cheat] NOCOOB (Edistynyt shakkiavustusjärjestelmä)
// @name:sw     🏆 [#1 Chess Cheat] NOCOOB (Advanserad Schack Assitant System)
// @name:zh-CN  🏆 [#1 Chess Cheat] NOCOOB（高级国际象棋辅助系统）
// @name:es     🏆 [#1 Chess Cheat] NOCOOB (Sistema Avanzado de Asistencia al Ajedrez)
// @name:hi     🏆 [#1 Chess Cheat] NOCOOB (उन्नत शतरंज सहायता प्रणाली)
// @name:ar     🏆 [#1 Chess Cheat] NOCOOB (نظام المساعدة المتقدم في الشطرنج)
// @name:pt     🏆 [#1 Chess Cheat] NOCOOB (Sistema Avançado de Assistência ao Xadrez)
// @name:ja     🏆 [#1 Chess Cheat] NOCOOB（先進的なチェス支援システム）
// @name:de     🏆 [#1 Chess Cheat] NOCOOB (Fortgeschrittenes Schach-Hilfesystem)
// @name:fr     🏆 [#1 Chess Cheat] NOCOOB (Système Avancé d'Assistance aux Échecs)
// @name:it     🏆 [#1 Chess Cheat] NOCOOB (Sistema Avanzato di Assistenza agli Scacchi)
// @name:ko     🏆 [#1 Chess Cheat] NOCOOB (고급 체스 보조 시스템)
// @name:nl     🏆 [#1 Chess Cheat] NOCOOB (Geavanceerd Schaakondersteuningssysteem)
// @name:pl     🏆 [#1 Chess Cheat] NOCOOB (Zaawansowany System Pomocy Szachowej)
// @name:tr     🏆 [#1 Chess Cheat] NOCOOB (Gelişmiş Satranç Yardım Sistemi)
// @name:vi     🏆 [#1 Chess Cheat] NOCOOB (Hệ Thống Hỗ Trợ Cờ Vua Nâng Cao)
// @name:uk     🏆 [#1 Chess Cheat] NOCOOB (Система передової допомоги в шахах)
// @name:ru     🏆 [#1 Chess Cheat] NOCOOB (Система расширенной помощи в шахматах)
...
// @homepageURL https://incaseddevelopment.github.io/NOCOOB
// @supportURL  https://github.com/incaseddevelopment/NOCOOB/tree/main#why-doesnt-it-work
// @match       https://incaseddevelopment.github.io/NOCOOB/*
...
// @icon        https://raw.githubusercontent.com/incaseddevelopment/NOCOOB/main/assets/images/grey-logo.png
// @version     2.1.6
// @namespace   HKR
// @author      HKR
// @license     GPL-3.0
...
Advanced Chess Assistance System (NOCOOB) v2 | Q3 2023

[WARNING]
- Please be advised that the use of NOCOOB may violate the rules and lead to disqualification or banning from tournaments and online platforms.
- The developers of NOCOOB and related systems will NOT be held accountable for any consequences resulting from its use.
- We strongly advise to use NOCOOB only in a controlled environment ethically.
...
const backendConfig = {
    'hosts': { 'prod': 'incaseddevelopment.github.io', 'dev': 'localhost' },
    'path': '/NOCOOB/'
};
