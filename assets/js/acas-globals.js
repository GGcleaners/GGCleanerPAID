const repositoryURL = 'https://github.com/incaseddevelopment/NOCOOB'; // old relics, not in use
const repositoryRawURL = null; // old relics, not in use

const log = {
    info: (...message) => console.log(`[NOCOOB]%c ${message.join(' ')}`, 'color: #67a9ef;'),
    success: (...message) => console.log(`[NOCOOB]%c ${message.join(' ')}`, 'color: #67f08a;')
};
